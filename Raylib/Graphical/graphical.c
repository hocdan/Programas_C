...
int main(){
    ...
    while (!WindowShouldClose()){
        ...
        if ( CheckCollisionPointRec( GetMousePosition(), botaoTipoFuncao) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)){
        ...
        if ( CheckCollisionPointRec( GetMousePosition(), botaoCalcular) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)){
            okTipo = FALSE;
            okCalcular = TRUE;
            okA = FALSE;
            okB = FALSE;
        ...
        if ( CheckCollisionPointRec( GetMousePosition(), botaoA) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)){
            strcpy(valor, ""); //resetando valor
            okTipo = FALSE;
            okCalcular = FALSE;
            okA = TRUE;
        ...
        if ( CheckCollisionPointRec( GetMousePosition(), botaoB) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)){
            strcpy(valor, ""); //resetando valor
            okTipo = FALSE;
            okCalcular = FALSE;
            okA = FALSE;
        ...
        if ( CheckCollisionPointRec( GetMousePosition(), botaoC) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)){
            strcpy(valor, ""); //resetando valor
            okTipo = FALSE;
            okCalcular = FALSE;
            okA = FALSE;
        ...
        if ( CheckCollisionPointRec( GetMousePosition(), botaoD) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)){
            strcpy(valor, ""); //resetando valor
            okTipo = FALSE;
            okCalcular = FALSE;
            okA = FALSE;
        ...
        if ( CheckCollisionPointRec( GetMousePosition(), botaoMaisA) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) okMaisA = TRUE;
        if ( CheckCollisionPointRec( GetMousePosition(), botaoMenosA) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) okMenosA = TRUE;
        if ( CheckCollisionPointRec( GetMousePosition(), botaoMaisB) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) okMaisB = TRUE;
        if ( CheckCollisionPointRec( GetMousePosition(), botaoMenosB) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) okMenosB = TRUE;
        if ( CheckCollisionPointRec( GetMousePosition(), botaoMaisC) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) okMaisC = TRUE;
        if ( CheckCollisionPointRec( GetMousePosition(), botaoMenosC) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) okMenosC = TRUE;
        if ( CheckCollisionPointRec( GetMousePosition(), botaoMaisD) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) okMaisD = TRUE;
        if ( CheckCollisionPointRec( GetMousePosition(), botaoMenosD) && IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) okMenosD = TRUE;
